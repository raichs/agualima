...
const TrafficSourceChart = () => {
    const TrafficChartOpts: ApexOptions = {
        ...
        series: [44, 55, 67, 22],
        labels: ['Completado', 'En Progreso', 'Por Empezar', 'Cancelado'],
        responsive: [
            {
                breakpoint: 380,
                options: {
        ...
        <Col xxl={4}>
            <Card>
                <CardHeader className="d-flex justify-content-between align-items-center border-bottom border-dashed">
                    <h4 className="header-title">Principales Fuentes de Tráfico</h4>
                    <Dropdown align={'end'}>
                        ...
                        <Col>
                            <div className="d-flex justify-content-between align-items-center p-1">
                                <div>
                                    ...
                                    <span className="align-middle fw-semibold">Directo</span>
                                </div>
