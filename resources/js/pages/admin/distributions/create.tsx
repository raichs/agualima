...
import { Project, Variety, Shift, Lot } from '@/types';
...
const CreateDistributionPage = () => {
    ...
    return (
        <>
            <PageTitle title="Crear Distribución" subTitle="Distribuciones" />
            <ComponentContainerCard title="Ingresa la información de la distribución">
                <Row>
                    <Col xs={12}>
