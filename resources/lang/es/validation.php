...
return [
    ...
    | ajustar cada mensaje según tus necesidades.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar mensajes personalizados para atributos utilizando
    | la convención "attribute.rule". Esto permite definir mensajes específicos
    | para cada regla de un atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Estas líneas se utilizan para reemplazar el marcador de posición :attribute
